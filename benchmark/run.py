...
cwd = os.getcwd()
os.chdir("../../data/images/kitti-some/")
imgs = os.listdir()
img_array=[]
for img in imgs:
    img_array.append(IMAGES_DIR+'kitti-some/'+img)
print (img_array)
os.chdir(cwd)
print (os.getcwd())
# img_array = [IMAGES_DIR + 'kitti-some/000008.png', IMAGES_DIR + 'kitti-some/000025.png', IMAGES_DIR + 'kitti-some/000031.png', IMAGES_DIR + 'kitti-some/000032.png']
